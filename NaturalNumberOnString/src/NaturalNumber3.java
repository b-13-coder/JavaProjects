...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final int divideBy10() {
        ...
        /*
         * if it's a single digit number, set number as remainder, set the
         * NaturalNumber to 0. else, take the last digit as a remainder, and the
         * rest of the number as the NaturalNumber
         */
        if (length == 1) {
            remainder = Integer.parseInt(this.rep);
            this.rep = "";
        } else {
            remainder = Integer.parseInt(this.rep.substring(length - 1));
